...
class CacheRepository(ABC):
    ...
    def upsert(self, wa_id: str, id_empresa: int, datos: dict, es_nuevo: bool) -> dict:
        """Inserta o actualiza según si el registro ya existe."""
        if es_nuevo:
            return self.insertar(wa_id, id_empresa, datos)
        return self.actualizar(wa_id, id_empresa, datos)
