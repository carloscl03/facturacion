...
from services.legacy.registrador_service import RegistradorService
    ...
    def ejecutar(self, wa_id: str, id_from: int) -> dict:
        ...
        if res_preg.get("listo_para_finalizar") is True:
            ...
            self._repo.actualizar(
                wa_id, id_from, {"metadata_ia": json.dumps(metadata_ia, ensure_ascii=False)}
            )
